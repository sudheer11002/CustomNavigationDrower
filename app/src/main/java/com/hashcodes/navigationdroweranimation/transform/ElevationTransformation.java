package com.hashcodes.navigationdroweranimation.transform;

import android.os.Build;
import android.view.View;

import com.hashcodes.navigationdroweranimation.util.SideNavUtils;


public class ElevationTransformation implements RootTransformation {

    private static final float START_ELEVATION = 6f;
